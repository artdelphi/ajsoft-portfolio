...
export default function Projects() {
  ...
  const categories = [
    ...
    { id: "desktop", name: t.projects.categories.desktop },
    { id: "mobile", name: t.projects.categories.mobile },
    { id: "iot", name: t.projects.categories.iot },
  ...
  const getProjectContent = (key) => {
    return t.projectItems[key] || { title: key, description: "", features: [] };
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project) => {
            const content = getProjectContent(project.key);
            return (
              <div
                key={project.id}
