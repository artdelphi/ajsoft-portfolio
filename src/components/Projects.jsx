...
export default function Projects() {
  ...
  const projects = [
    {
      id: 1,
      title: "ระบบเช็คสต๊อกสินค้า",
      description: "ระบบจัดการสต๊อกสินค้าครบวงจร รองรับการนำเข้า-ส่งออก ตรวจสอบยอดคงเหลือ และรายงานสต๊อกแบบ Real-time",
      image: "📦",
      category: "fullstack",
      tags: ["Delphi", "MySQL", "REST API"],
      liveUrl: "#",
      githubUrl: "#",
      features: ["จัดการสินค้าคงคลัง", "รายงานสต๊อก", "แจ้งเตือนสินค้าใกล้หมด", "ประวัติการเคลื่อนไหว"],
    },
    {
      id: 2,
      title: "Web สะสมคะแนน Line OA",
    ...
    },
    {
      ...
      image: "🍽️",
      category: "fullstack",
      tags: ["Delphi", "PostgreSQL", "Socket.io"],
      liveUrl: "#",
      githubUrl: "#",
    ...
    {
      id: 6,
      title: "ESP32 MicroSD Card",
      description: "โปรเจค IoT สำหรับอ่าน/เขียนข้อมูลจาก MicroSD Card บน ESP32",
      image: "📡",
      category: "iot",
      tags: ["ESP32", "C++", "IoT", "MicroSD"],
      liveUrl: "#",
      githubUrl: "#",
      features: ["อ่าน/เขียน SD Card", "Data Logging", "IoT Integration", "Low Power"],
    },
    {
      id: 7,
    ...
    },
    {
      ...
      description: "พัฒนาแอปพลิเคชันมือถือด้วย Flutter และ Android Native สำหรับธุรกิจต่างๆ",
      image: "📱",
      category: "mobile",
      tags: ["Flutter", "Android", "Dart", "Kotlin"],
      liveUrl: "#",
      githubUrl: "#",
