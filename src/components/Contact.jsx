      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-semibold text-white mb-4">Let's Build Something Great</h3>
              <p className="text-gray-400 leading-relaxed">
                I'm available for freelance projects, consulting, and full-time opportunities.
                Whether you need a web application, mobile app, desktop software, or AI integration,
