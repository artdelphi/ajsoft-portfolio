      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-semibold text-white mb-4">{t.contact.heading}</h3>
            ...
            {/* Social Links */}
            <div>
              <h4 className="text-white font-medium mb-4">{t.contact.connectWith}</h4>
          ...
          <div className="bg-[#1e293b] rounded-2xl p-8 border border-[#334155]">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-gray-400 text-sm mb-2">{t.contact.form.name}</label>
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
                ...
                <div>
                  <label className="block text-gray-400 text-sm mb-2">{t.contact.form.email}</label>
                  <input
                    type="email"
                    name="email"
              ...
              <div>
                <label className="block text-gray-400 text-sm mb-2">{t.contact.form.subject}</label>
                <input
                  type="text"
                  name="subject"
              ...
              <div>
                <label className="block text-gray-400 text-sm mb-2">{t.contact.form.message}</label>
                <textarea
                  name="message"
